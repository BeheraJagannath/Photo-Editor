...
//        _imgSrc.value = imgSrc
    ...
    private fun setUriOrBitmap(navArgs: PaintFragmentArgs) {
...
//                        _imgSrc.value!!.config = Bitmap.Config.ARGB_8888 // this is important
                        ...
                        val resizePhoto = ResizePhoto(context, BitmapHelper.bitmap!!, true, UriBitmapUtils.RESOLUTION.HD_720P)
