package com.example.neweditor.customView.widget;
...
import com.example.neweditor.customView.rotateView.CropImageView;
...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    private void init(@NonNull TypedArray a) {
        ...
        int activeColor = getResources().getColor(R.color.shimmer_highlight);
        applyActiveColor(activeColor);
