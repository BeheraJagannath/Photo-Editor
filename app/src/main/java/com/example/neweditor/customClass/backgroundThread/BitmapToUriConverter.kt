...
import com.example.neweditor.viewModel.ResizePhoto
import com.example.neweditor.viewModel.UriBitmapUtils
...
//
    ...
    private fun uriToBitmap(uri: Uri): Bitmap? {
        ...
        if (bitmap != null) {
            return if (bitmap.width >= UriBitmapUtils.RESOLUTION.HD_720P.width && bitmap.height >= UriBitmapUtils.RESOLUTION.HD_720P.height) {
